package com.softserve.edu03elem;
...
public class WebElementsTest {
    ...
    public void checkWebElements() throws Exception {
        ...
        */
        ...
        presentationSleep(); // For Presentation ONLY
        //
        Assertions.assertTrue(login.getAttribute("value").contains("hahaha"));
        presentationSleep(); // For Presentation ONLY
        //
        /*-
    ...
    public void checkExistWebElement() throws Exception {
        ...
        System.out.println("1. isVisible Login Link = "
                + driver.findElement(By.cssSelector("a[href*='route=account/login']")).isDisplayed());
        presentationSleep(); // For Presentation ONLY
        //
        // My Account
